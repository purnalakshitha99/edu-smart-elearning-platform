...
def get_qa():
    try:
        ...
        for quiz in quizzes:
            ...
            quiz["question_length"] = len(quiz.get("questions", []))  # Use get() method safely

        return json_util.dumps(quizzes, default=json_util.default), 200  #Use dumps to properly display the response
    except Exception as e:
